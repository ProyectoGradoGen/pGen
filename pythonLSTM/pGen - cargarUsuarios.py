...
json.dump(listaUsuario, open('C:\\proyecto\\NotebookParaClasificarConEmojis\\listaUsuario.json', 'w') )
json.dump(yUsuarios, open('C:\\proyecto\\NotebookParaClasificarConEmojis\\yUsuarios.json', 'w') )
